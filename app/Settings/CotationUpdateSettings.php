...
class CotationUpdateSettings extends Settings
{
                    ...
                    ->schema([
                        ...
                        Repeater::make('rateLimiters')
                            ...
                            ->schema([
                                Select::make('service')
                                    ->label('Service')
                                    ->options(CotationUpdateMethod::dropdown())
                                    ->required()
                                    ->searchable(),
                            ...
                            ->itemLabel(
                                ...
                                $state['service'] ? CotationUpdateMethod::from($state['service'])->getLabel() . ' (' . $state['rate_limit_seconds'] . 's)' : null
                            ),
                    ])
            ])
        ];
