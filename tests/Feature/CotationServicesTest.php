...
class CotationServicesTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_css_selector_success(): void
    {
        ...
        $c = Cotation::create([
            'name' => 'TEST',
            'currency_id' => $currency->id,
            'update_method' => CotationUpdateMethod::CSS,
    ...
    public function test_coingecko_success(): void
    {
        ...
        $c = Cotation::create([
            'name' => 'BTC',
            'currency_id' => $currency->id,
            'update_method' => CotationUpdateMethod::COINGECKO,
        ...
        $service = new CotationCoingecko($c);
    ...
    public function test_command_cotation_success(): void
    {
        ...
        $c = Cotation::create([
            'name' => 'CMD',
            'currency_id' => $currency->id,
            'update_method' => CotationUpdateMethod::COMMAND,
            'update_data' => ['command' => 'php -r "echo 123.45;"'],
            'user_id' => Auth::id(),
        ]);

        $service = new CotationCommand($c);
